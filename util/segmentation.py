...
def segmentation_nucleus_otsu_3D(img_0,img_pixel_microns,arg_nucleus_diameter_micron):
  nucleus_size_threshold = 4/3*np.pi*(arg_nucleus_diameter_micron/2)**3/img_pixel_microns/img_pixel_microns/img_pixel_microns
